...
const dummyMenuItems = <MenuItemModel>[
  MenuItemModel(
    ...
    category: 'Starters',
    price: 4.5,
    imageUrl: 'https://picsum.photos/seed/garlicbread/400',
  ),
  MenuItemModel(
    name: 'Bruschetta',
    category: 'Starters',
    price: 5.5,
    imageUrl: 'https://picsum.photos/seed/bruschetta/400',
  ),
  MenuItemModel(
    name: 'Veggie Soup',
    category: 'Starters',
    price: 6.0,
    imageUrl: 'https://picsum.photos/seed/soup/400',
  ),
  MenuItemModel(
    name: 'Caesar Salad',
    category: 'Starters',
    price: 7.0,
    imageUrl: 'https://picsum.photos/seed/salad/400',
  ),
  MenuItemModel(
    name: 'Paneer Tikka',
    category: 'Starters',
    price: 8.5,
    imageUrl: 'https://picsum.photos/seed/paneer/400',
  ),
  MenuItemModel(
  ...
  MenuItemModel(
    ...
    category: 'Main Course',
    price: 13.5,
    imageUrl: 'https://picsum.photos/seed/bbqpizza/400',
  ),
  MenuItemModel(
    name: 'Veggie Burger',
    category: 'Main Course',
    price: 11.0,
    imageUrl: 'https://picsum.photos/seed/burger/400',
  ),
  MenuItemModel(
    name: 'Pasta Alfredo',
    category: 'Main Course',
    price: 12.5,
    imageUrl: 'https://picsum.photos/seed/pasta/400',
  ),
  MenuItemModel(
    name: 'Grilled Salmon',
    category: 'Main Course',
    price: 16.0,
    imageUrl: 'https://picsum.photos/seed/salmon/400',
  ),
  MenuItemModel(
    name: 'Steak Frites',
    category: 'Main Course',
    price: 18.5,
    imageUrl: 'https://picsum.photos/seed/steak/400',
  ),
  MenuItemModel(
    name: 'Tandoori Platter',
    category: 'Main Course',
    price: 17.0,
    imageUrl: 'https://picsum.photos/seed/tandoori/400',
  ),
  MenuItemModel(
    name: 'Lemonade',
    category: 'Drinks',
    price: 3.5,
    imageUrl: 'https://picsum.photos/seed/lemonade/400',
  ),
  MenuItemModel(
    name: 'Iced Tea',
    category: 'Drinks',
    price: 3.0,
    imageUrl: 'https://picsum.photos/seed/icedtea/400',
  ),
  MenuItemModel(
    name: 'Mojito',
    category: 'Drinks',
    price: 4.5,
    imageUrl: 'https://picsum.photos/seed/mojito/400',
  ),
  MenuItemModel(
    name: 'Mango Lassi',
    category: 'Drinks',
    price: 4.0,
    imageUrl: 'https://picsum.photos/seed/lassi/400',
  ),
  MenuItemModel(
    name: 'Chocolate Shake',
    category: 'Drinks',
    price: 4.5,
    imageUrl: 'https://picsum.photos/seed/shake/400',
  ),
  MenuItemModel(
    name: 'Cheesecake',
    category: 'Desserts',
    price: 6.5,
    imageUrl: 'https://picsum.photos/seed/cheesecake/400',
  ),
  MenuItemModel(
    name: 'Brownie Sundae',
    category: 'Desserts',
    price: 6.0,
    imageUrl: 'https://picsum.photos/seed/brownie/400',
  ),
  MenuItemModel(
    name: 'Tiramisu',
    category: 'Desserts',
    price: 7.5,
    imageUrl: 'https://picsum.photos/seed/tiramisu/400',
  ),
  MenuItemModel(
    name: 'Gulab Jamun',
    category: 'Desserts',
    price: 5.0,
    imageUrl: 'https://picsum.photos/seed/gulab/400',
  ),
  MenuItemModel(
    name: 'Ice Cream Trio',
    category: 'Desserts',
    price: 5.5,
    imageUrl: 'https://picsum.photos/seed/icecream/400',
  ),
];
