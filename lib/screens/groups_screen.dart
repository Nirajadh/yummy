...
class _GroupsScreenState extends State<GroupsScreen> {
  ...
  void initState() {
    super.initState();
    _groups = List.of(dummyGroups);
  }

  void _openForm({GroupInfo? group, int? index}) {
  ...
  Widget build(BuildContext context) {
    final activeEntries = _groups
        .asMap()
        .entries
        .where((e) => e.value.isActive)
        .toList();
    final closedEntries = _groups
        .asMap()
        .entries
        .where((e) => !e.value.isActive)
        .toList();
        ...
        body: TabBarView(
          children: [
            _GroupList(
              ...
              onEdit: (index) => _openForm(group: _groups[index], index: index),
...
class _GroupList extends StatelessWidget {
  final List<MapEntry<int, GroupInfo>> entries;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      TextButton.icon(
                        onPressed: () => onToggleStatus(groupIndex),
                        icon: Icon(
...
class GroupFormSheet extends StatefulWidget {
  ...
  final ValueChanged<GroupInfo> onSave;
